<%@ Control Language="vb" AutoEventWireup="false" Inherits="CEI.Application.Intelliclaim.UserService.LW.Letters.LW_CB_ShopEstAssignment" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
            ...
            <TD valign=top width="50%">
              <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <TR>
                  ...
                  <TD CLASS="TextNormal CellValue"><%=Me.ClaimClient%></TD>
                </TR>
                <TR>
                  <TD CLASS="TextNormal CellLabel">Branch:</TD>
                  <TD CLASS="TextNormal CellValue"><%=Me.ClaimBranch%></TD>
                </TR>
                <TR>
  ...
  <TR>
    <TD height="1px">
      ...
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <TR>
          <TD CLASS="TextSmallBold" align="center">Page 1 of 1</TD>
        </TR>
      </TABLE>
    </TD>
  </TR>
