...
<LW:PAGE runat=server id="PG_1" pagenumber="1" pagecount="1">
        ...
        <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <TR>
                <TD style="font:normal 10pt Sans-Serif;">
                    In regards to the above accident, <%=Me.GetProperCEIName(Me.OrgCountryId, "CEI Services")%> is the Third Party Administrator for the names client's auto physical damage.<p>
                    At this time, <%=Me.GetProperCEIName(Me.OrgCountryId, "CEI Services")%> is waiting for the completed subrogation paperwork, which we will immediately forward to your attention.<P>
                    <LW:EditBox runat="server" id="Txt_Comments" width="100%" height="100px" /><P>
                    If you have any questions please call us at 1-215-364-8253 (option 2).
            </TR>                 
        </TABLE>
    </DIV>
    ...
    <DIV style="padding-top:20px;">
        <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <TR>
                <TD style="font:normal 10pt Sans-Serif;">Claims Representative</TD>
            </TR>
            <TR>
                <TD style="font:normal 10pt Sans-Serif;"><%=Me.GetProperCEIName(Me.OrgCountryId, "CEI Services")%></TD>
            </TR>
            <TR>
                <TD style="font:normal 10pt Sans-Serif;">1-215-364-8253 (option 2)</TD>
            </TR>            
        </TABLE>
    </DIV>
    ...
    <DIV style="padding-top:20px;">
        <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
            <TR>
                <TD style="font:normal 10pt Sans-Serif;">
                  Please diary your file 30 days while <%=Me.GetProperCEIName(Me.OrgCountryId, "CEI Services")%> prepares our subrogation demand.
                </td>
            </TR>                 
        </TABLE>
    </DIV>
...
<script runat="server">
  Public Const cDisablePstComment As String = "LR.Contact.DisablePstComment"
