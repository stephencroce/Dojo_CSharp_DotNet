        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
	      ...
	      Pour la traduction en Anglais, s’il vous plaît regardez au-dessous. <p/> 
              ...
              <%  If Me.UseAffidavit Then%>
                ...
                <p/>
                <span class="TextBold"><u>IMPORTANT</u>: Puisque nous n'avons pas reçu votre document de certification pour cet accident/incident, vos privilèges de carte d’essence seront annulés dans les prochaines 48 heures, conformément à la Politique de véhicule de parc HP.  Dès que le formulaire de certification signé sera reçu, GE sera avisé d’envoyer une nouvelle carte d’essence .  Si vous avez déjà soumis le document de certification, veuillez communiquer avec CEI Services au (215) 485-4284.</span>
                <p/>
                Si vous n’avez pas soumis votre document de certification, nous vous recommandons de retourner le document signé <b>par l’une des méthodes suivantes </b>:               
                <p/>
                   <table border="0" cellpadding="0" cellspacing="0" style="padding-left:20px;">
                    <tr>
                      <td class="TextNormal">Télécopieur:</td> 
              ...
              <%  Else%>
                CEI a déjà communiqué avec vous sur plusieurs occasion au sujet de la soumission d'un document de certification, conformément à la Politique de véhicule de parc nord-américain HP, article 6 - Sécurité du véhicule et participant, laquelle vous pouvez consulter sur http://hp.gefleet.com.
                <p/>
                <span class="TextBold"><u>IMPORTANT</u>: Puisque nous n’avons toujours pas reçu votre paiement, vos privilèges de carte d’essence seront annulés dans les prochaines 48 heures, conformément à la Politique de véhicule de parc HP. Dès que votre paiement sera reçu, GE sera avisé d’envoyer une nouvelle carte d’essence. </span>
                <p/>
