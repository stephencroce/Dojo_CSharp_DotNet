          ...
          <tr>
            <td class="TextNormal" align="left" style="padding-top:5px;">
             ...
             <%  If Me.UseAffidavit Then%>
                ...
                CEI a déjà communiqué avec vous deux fois au sujet de la soumission d'un document de certification, conformément à la Politique de véhicule de parc nord-américain HP, article 6 - Sécurité du véhicule et participant, laquelle vous pouvez consulter sur http://hp.gefleet.com.
                <p/>
 
				<span class="TextBold" style="color:#ffcc" ><u>IMPORTANT</u>: Puisque nous n'avons pas reçu votre document de certification pour cet accident/incident, vos privilèges de carte d’essence seront annulés dans les prochaines 48 heures, conformément à la Politique de véhicule de parc HP.  Dès que le formulaire de certification signé sera reçu, GE sera avisé d’envoyer une nouvelle carte d’essence .  Si vous avez déjà soumis le document de certification, veuillez communiquer avec CEI Services au (215) 485-4284.
                </span>
                <p/>
                
                Si vous n’avez pas soumis votre document de certification, nous vous recommandons de retourner le document signé par services de messagerie et de communiquer avec CEI au (215) 485-4284 avec les informations de suivi en main dans les prochaines 24 heures afin que votre carte d’essence ne soit pas désactivée. 
                <p/>

              <%  Else%>
			  
                CEI a déjà communiqué avec vous deux fois demandant le paiement de frais d'accident/incident payables, conformément à la Politique de véhicule de parc nord-américain HP, article 6 - Sécurité du véhicule et participant, laquelle vous pouvez consulter au http://hp.gefleet.com.
                <p/>
               
                <span class="TextBold">IMPORTANT: Puisque nous n’avons toujours pas reçu votre paiement, vos privilèges de carte d’essence seront annulés dans les prochaines 48 heures, conformément à la Politique de véhicule de parc HP. Dès que votre paiement sera reçu, GE sera avisé d’envoyer une nouvelle carte d’essence.
				</span><p/>
                
                <b>Si vous avez déjà soumis votre paiement, veuillez communiquer avec CEI Services au  <nobr>215-485-4284</nobr></b><p/>
                
				Si vous n’avez pas soumis votre paiement, nous vous recommandons d’envoyer le paiement par services de messagerie et de communiquer avec CEI au (215) 485-4284 avec les informations de suivi en main dans les prochaines 24 heures afin que votre carte d’essence ne soit pas désactivée.   Le paiement au montant de <%=Me.Payment %> devrait être à l’ordre de  CEI Services et soumis à l’adresse suivante:
                <p/>              
              ...
              <% If Me.UseAffidavit Then%>
                ...
                Nous vous demandons de vous assurer que votre obligation soit acquittée et que le formulaire de certification soit soumis à CEI.   
                  ...
                  <tr>
                    <td class="TextNormal" style="padding-bottom:10px;">
                      <ol>
                        ...
                        <li style="TEXT-ALIGN: justify">J’ai fourni toutes les informations que je possède concernant l’occurrence afin d’assister HP dans le recouvrement des coûts de réparation du véhicule; </li>
                      </ol>
                    </td>
                  </tr>
                  <tr>
          ...
          <tr>
            <td class="TextNormal" align="left" style="padding-top:5px;">
              ...
              <%  If Me.UseAffidavit Then%>
                  ...
                  CEI previously contacted you twice regarding the submittal of a Certification document, per the HP North America Fleet Policy, Section 6 – Participant & Vehicle Safety, which can be accessed at http://hp.gefleet.com. <p/>
                  
                  <span class="TextBold" style="color:#ffcc" >IMPORTANT: Since we have not received your Certification document for this accident/incident, your fuel card privileges are scheduled for cancellation within 48 hours, per HP’s Fleet Policy.  Once the signed Certification form is received, GE will be notified to send out a new fuel card.  If you have already submitted the Certification document please contact CEI Services at (215) 485-4284.</span><p/>
                  
                  If you have not submitted your certification, we recommend you return the signed document by courier, and contact CEI at (215) 485-4284 with tracking information within the next 24 hours so that your fuel card will not be disabled. 
                   <p/>
                                      
              <%  Else%>
                CEI previously contacted you twice requesting payment of a chargeable accident/incident fee, per the HP North America Fleet Policy, Section 6 – Participant &amp; Vehicle Safety, which can be accessed at http://hp.gefleet.com<p/>
                
                <span class="TextBold">IMPORTANT: Since we have not received your payment for this accident/incident, your fuel card privileges are scheduled for cancellation within 48 hours, per HP’s Fleet Policy.  Once payment is received, GE will be notified to send out a new fuel card.</span><p/>
               
                <b>If you have submitted payment please contact CEI Services at <nobr>215-485-4284</nobr></b><p/>
                
                If you have not submitted your payment, we recommend you forward a check immediately by courier, and contact CEI at <nobr>215-485-4284</nobr> with tracking information within the next 24 hours so that your fuel card will not be disabled. Payment in the amount of <%=Me.Payment%>, should be made payable to <%=Me.PayableTo%> and submitted to the following address:<p/>
              ...
              <% If Me.UseAffidavit Then%>
                We ask you to ensure your obligation is satisfied, and that the Certification form is submitted to CEI.   If you have questions, please contact CEI Services at 215-485-4284, or hp@ceinetwork.com.<p/>
              <% Else%>
                HP fleet drivers are responsible for all vehicle payment obligations, as they relate to violations or fines, per the HP North America Fleet Policy.  Failure to comply with this policy may result in further action, including loss of fleet driver privileges.  For this reason, we ask you to ensure your payment obligation is satisfied.
                  ...
                  If you have questions, please contact CEI Services:<p/>
                  <table border="0" cellpadding="0" cellspacing="0" style="padding-left:20px;">
                    <tr>
                      <td class="TextNormal">Telephone:</td> 
                      <td class="TextNormal">215-485-4284</td> 
                    </tr>
                    <tr>
                      <td class="TextNormal">Email:</td> 
            ...
            <td class="TextNormal" align="left" style="padding-top:5px;">
              ...
              <div>
                <table border="0" cellpadding="0" cellspacing="0" style="width:500px;">
                  ...
                  <tr>
                    <td class="TextNormal">Address:</td>
                    <td class="TextNormal" style="padding-top:5px; width:100%;">
                      <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="SquareTextBox">&nbsp;</td></tr></table>
                    </td>
                  </tr>
