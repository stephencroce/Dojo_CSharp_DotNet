<%@ Control Language="vb" AutoEventWireup="false" Inherits="CEI.Application.Intelliclaim.UserService.LW.Templates.MiscVendorAssignment" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
    ...
    <TD height="100%" valign="TOP">
      ...
      <DIV style="margin-top:5px;">
        <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <TR style="display:<%=iif(Me.ShopContact.Length = 0,"none","inline")%>">
      ...
      <DIV style="margin-top:10px;">
        <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
          <TR>
            <TD CLASS="TextLargeNormal CellTitle" colspan=2><B>CEI Informatie Purchase Order</B> (Bestelbon)</TD>
          </TR>
          <TR>
            <TD valign=top width="50%" style="padding-top:5px;">
              <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
                <TR>
                  <TD CLASS="TextNormal CellLabel">Omschrijving:</TD>
                  <TD CLASS="TextNormal CellValue"><%=Me.MiscType%></TD>
                </TR>
                <TR>
                  <TD CLASS="TextNormal CellLabel">Datum schade:</TD>
                  <TD CLASS="TextNormal CellValue"><%=Me.PODate%></TD>
                </TR>
              </TABLE>
            </TD>
            <TD valign=top width="100%">
              <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
                <TR>
                  <TD CLASS="TextNormal CellLabel">PO Nummer:</TD>
                  <TD CLASS="TextNormal CellValue"><%=Me.PONumber%></TD>
                </TR>
                <TR>
                  <TD CLASS="TextNormal CellLabel">PO Bedrag:</TD>
                  <TD CLASS="TextNormal CellValue"><%=Me.POAmount%></TD>
                </TR>
              </TABLE>
            </TD>
          </TR>
    ...
    <TD height="1px">
      ...
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
        <TR>
          ...
          <TD CLASS="TextSmallNormal" style="font:normal 5pt arial; padding-top:5px; border-top:solid 1px #000000;" align="right">Templates/nl/BE/MiscVendorAssignment.ascx</TD>
        </TR>
        <TR>
