...
<%
    Const TemplatePath As String = "Templates/en/CA/HP/HP_3rd_Deductible.ascx"
    Dim HeaderA As String = Me.GetProperCEIName(Me.OrgCountryId, "The CEI Group, Inc.") & "The CEI Group, Inc.<br/>4850 E. Street Road<br/>Trevose, PA 19053-6646"
          ...
          <tr>
            <td class="TextNormal" align="left" style="padding-top:5px;">
              ...
              <%  If Me.UseAffidavit Then%>
                CEI previously contacted you twice requesting payment of a chargeable accident/incident fee or the submittal of a Certification document, per the HP North America Fleet Policy, Section 7 – HP Driver & Vehicle Safety, which can be accessed at http://hp.gefleet.com<p/>
                <span class="">IMPORTANT: Since we have not received your payment, or the Certification document for this accident/incident, your fuel card privileges are scheduled for cancellation within 48 hours, per HP’s Fleet Policy.  Once payment or the signed Certification form is received, GE will be notified to send out a new fuel card.</span><p/>
                <b>If you have submitted payment or the Certification document please contact CEI Services at <nobr>215-485-4353</nobr></b><p/>
                If you have not submitted your certification or payment, we recommend you return the signed Certification, or forward a check immediately by courier, and contact CEI at <nobr>215-485-4353</nobr> with tracking information within the next 24 hours so that your fuel card will not be disabled. If you are not returning the signed Certification, then payment in the amount of <%=Me.Payment%>, should be made payable to CEI Services and submitted to the following address:<p/>
              <%  Else%>
                CEI previously contacted you twice requesting payment of a chargeable accident/incident fee, per the HP North America Fleet Policy, Section 7 – HP Driver & Vehicle Safety, which can be accessed at http://hp.gefleet.com<p/>
                <span class="">IMPORTANT: Since we have not received your payment for this accident/incident, your fuel card privileges are scheduled for cancellation within 48 hours, per HP’s Fleet Policy.  Once payment is received, GE will be notified to send out a new fuel card.</span><p/>
                <b>If you have submitted payment please contact CEI Services at <nobr>215-485-4353</nobr></b><p/>
                If you have not submitted your payment, we recommend you forward a check immediately by courier, and contact CEI at <nobr>215-485-4353</nobr> with tracking information within the next 24 hours so that your fuel card will not be disabled. Payment in the amount of <%=Me.Payment%>, should be made payable to <%=Me.PayableTo%>and submitted to the following address:<p/>
              <%  End If%>
              ...
              Vehicle accident/incident details including late fees:<p/>
              ...
              <table border="0" cellpadding="0" cellspacing="0" style="padding-left:20px;">
                <tr>
                  ...
                  <td class="TextNormal">215-485-4353</td> 
                </tr>
                <tr>
            ...
            <td class="TextNormal" align="left" style="padding-top:5px;">
              ...
              <div>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    <td class="TextNormal" style="padding-bottom:20px;">If you are unable or unwilling to complete the certification below, you will be responsible to pay the invoiced <b><%=Me.Payment%></b> penalty fee for this event, as stated on page 1.</td>
                  </tr>
                  <tr>
