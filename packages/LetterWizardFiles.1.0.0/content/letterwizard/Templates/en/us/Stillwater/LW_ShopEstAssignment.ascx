...
<table border="0" cellpadding="0" cellspacing="0" class="page">
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
                <tr>
                    ...
                    <td align="center" style="width:33%; text-align: center" class="textLarge">
                        <span class="text textUnderline textLarge textBold">STILLWATER INSURANCE</span><br />
    ...
    <tr>
        <td width="100%" class="text" valign="top">
            <ul>
                <li>CEI is managing the repair and will pay the claim on behalf of Stillwater Insurance. <span class="text textBold">This is not a standard fleet claim.</span></li>
                <li>Stillwater Insurance is CEI's customer.</li>
    ...
    <tr>
        <td width="100%">
            <div style="text-align: center" class="textLarge textBold">
                ...
                <span class="textUnderline">Account: Stillwater Insurance</span>
            </div>
            <br />
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="text" style="border:solid 1px black; width:100%">
                    ...
                    <td style="width:85%">
                        ...
                        <span class="textItalic">
                            ** Vehicles <span class="textUnderline">12</span> months old or less from the date of manufacture with less than <span class="textUnderline">12,000</span> miles must be written with all new OEM parts.<br />
                            <span class="textBold">** 2-3 years:</span> LKQ or reconditioned parts for sheet metal &amp; plastic body parts. Non-OEM (CAPA) for radiators, condensers, lamps, mufflers, shocks and wheels.<br />
                            <span class="textBold">** 3-5 years:</span> Write available LKQ &amp; C.A.P.A. certified aftermarket (not structural)<br />
                            <span class="textBold">** 5+ years:</span> Write available C.A.P.A. certified aftermarket parts<br />
                            <br />
                            <span class="textBold">***Must note all sources if LKQ & Aftermarket Parts are not available</span><br />
                            <span class="textBold">***No LKQ safety items (steering, suspension, brakes, etc.)</span><br />
                            <span class="textBold">***No recycled or aftermarket on safety items such as: steering, suspension, brakes, and restraint systems</span><br />
                        </span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="border-bottom: solid 1px black; width:85%">
                        70% = Threshold: Complete Estimate and Photos, Note Open Items.  CEI  to notify Adjuster of Total Loss Recommendation. No Teardown without CEI's approval.<br />
                ...
                <tr>
                    ...
                    <td style=" width:85%">
                        2 Hours (Must be listed in hours)
                    </td>
                </tr>
                <tr>
                    <td style="font-style: italic;  width: 15%">
                ...
                <tr>
                    ...
                    <td style="width:85%">
                        1/2 Base Refinish Time: inc C/C (2 Panel Max)
                    </td>
                </tr>
                <tr>
                    <td style="font-style: italic; width: 15%">
                ...
                <tr>
                    ...
                    <td style="width:85%">
                        1.0 Hour - 1st Panel: 0.5 all others (2.5 Max)
                    </td>
                </tr>
                <tr>
                    <td style="font-style: italic; width: 15%">
                    ...
                    <td style="width:85%">
                        Should be considered on all applicable parts
                    </td>
                </tr>
                <tr>
                    <td style="font-style: italic; width: 15%" VAlign="Top">
    ...
    <tr>
        <td width="100%">
            ...
            <div style="width:100%; border: solid 1px black; padding: 5px;">
                ...
                <p>I authorize Stillwater / <%=this.getProperCEIName(this.getOrgCountryId(), "The CEI Group, Inc.")%> to make payment on my behalf to the above mention auto repair shop for the portion 
...
<script runat="server">
  ...
  public override string Subject {
    get {
      return "Stillwater Claim Assignment - Claim Id: {0}";
    }
  }
