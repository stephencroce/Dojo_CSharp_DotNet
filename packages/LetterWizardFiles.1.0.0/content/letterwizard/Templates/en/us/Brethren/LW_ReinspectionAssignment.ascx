                ...
                <table border="0" cellpadding="10" cellspacing="0" style="width:99%; height: 199px;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left" class="text">
                            <span class="textLarge textBold">Carrier: </span><span class="textLarge textBold textUnderline">Brethren Mutual Insurance</span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align: left" class="text">
    ...
    <tr>
        <td>
             <table border="1" cellpadding="3" cellspacing="0" style="width:100%; border:solid 1px">
                 <tr>
                     <td style="width:30%;text-align:left;vertical-align:top"><span class="textSmall">Name<br />Brethren Mutual Insurance<br /><br />Claim Number<br />&nbsp;</span></td>
