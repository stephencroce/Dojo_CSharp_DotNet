    ...
    %>
     ...
     %>
      ...
      <DIV style="margin-top:10px;">
        <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
          <TR>
            <TD valign="top" class="TextNormal">If any of the above information is incorrect, please contact our offices at 1-877-307-0460 and refer to claim number <B><%=Me.ClaimNumber%></B>.</TD>
          </TR>
        </TABLE>
      </DIV>
    ...
    <TD height="1px">
      ...
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%">
        <TR>
          ...
          <TD CLASS="TextSmallNormal" style="font:normal 5pt arial; padding-top:5px; border-top:solid 1px #000000;" align="right">Templates/en/us/ShopRepairAssignment.ascx</TD>
        </TR>
        <TR>
