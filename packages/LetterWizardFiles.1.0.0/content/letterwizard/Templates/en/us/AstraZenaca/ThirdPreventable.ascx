...
<% 
    ...
    Dim HeaderA As String = Me.GetProperCEIName(this.OrgCountryId, "The CEI Group, Inc.") & "<br/>4850 E. Street Road<br/>Trevose, PA 19053-6646"
            ...
            <td class="TextNormal" align="left" style="padding-top:5px;">
             ...
             <table border="0" cellpadding="0" cellspacing="0" style="padding-left:0px;">
                    ...
                    <tr>
                      ...
                      <td class="TextNormal">3rd Preventable Accident / Incident</td>
                    </tr>
              </table>

              <p/>

On <%=Me.Helper.DateOfLoss%> you had an accident deemed to be a third preventable accident/incident.   
In accordance with the AstraZeneca Fleet Motor Vehicle Safety and Usage Policy your financial responsibility for a 
third preventable accident/incident is <%=Me.Payment%>.
You have 30 days from the date of this letter to make payment.  
<p/>
