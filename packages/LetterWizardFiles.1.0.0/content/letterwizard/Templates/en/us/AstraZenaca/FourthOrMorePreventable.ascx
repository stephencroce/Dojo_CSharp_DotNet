...
<% 
    Const TemplatePath As String = "Templates/en/us/AstraZeneca/ThirdPreventable.ascx"
            ...
            <td class="TextNormal" align="left" style="padding-top:5px;">
             ...
             <table border="0" cellpadding="0" cellspacing="0" style="padding-left:0px;">
                    ...
                    <tr>
                      ...
                      <td class="TextNormal">4th or More Preventable Accident / Incident</td>
                    </tr>
              </table>

              <p/>

On <%=Me.Helper.DateOfLoss%> you had an accident deemed to be a preventable accident/incident. This incident is your fourth or more. 
In accordance with the AstraZeneca Fleet Motor Vehicle Safety and Usage Policy your financial responsibility for a 
fourth or more preventable accident/incident is <%=Me.Payment%>.
...
Please forward a check in the amount of <b> <%=Me.Payment%></b> prior to <%=Me.ForestDueDate%>, made payable to <b>"CEI Services"</b>. 
...
For questions regarding this accident/incident, please contact CEI at <b>astrazeneca@ceinetwork.com</b> or <b>215-485-4560</b>.
