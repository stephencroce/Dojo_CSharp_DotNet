...
<%
    Const TemplatePath As String = "Templates/en/us/Allergan/Allergan_3rd_Offense.ascx"
...
On <%=Me.Helper.DateOfLoss%>  you had a third preventable accident/incident.  
In accordance with the Allergan Fleet Safety Policy the financial responsibility 
for a third preventable accident/incident is <%=Me.Payment%>.  
...
<script runat="server">
    ...
    Private Sub _Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load, Me.Init
        Me.DPTemplateID = 32
    End Sub
