...
<%
    Const TemplatePath As String = "Templates/en/us/Allergan/AllerganFinalEscalation.ascx"
...
<p /> 
On <%=Me.FirstLetterSentDt.DisplayDate().ToString()%> CEI Services sent you first notification of your obligation, 
regarding the accident/incident that occurred with your Allergan assigned Fleet 
vehicle (see below claim information). 
A reminder was sent on <%=Me.ForestReminderLetterSentDate.DisplayDate.ToString%>.  
Therefore, this is a notification advising you that your payment is past 
due as of 
...
<p/>
Since your Payment has not been received, this notification is being copied to your 
immediate manager and also to the Human Resources department responsible for your area.
<p/>
