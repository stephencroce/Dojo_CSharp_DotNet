...
<table border="0" cellpadding="0" cellspacing="0" style="padding-left:20px;">
    ...
    <tr> 
      <td class="TextBold">Allergan Assigned Driver:&nbsp;&nbsp; </td>
    ...
    <tr>
      ...
      <td class="TextNormal"><%=IIf(Me.ForestDueDate.DisplayDate.EndsWith("0001"), Date.Now.AddDays(Me.ForestNumberOfDaysForPayment).ToString("MM/dd/yyyy"), Me.ForestDueDate.DisplayDate) %> </td>
    </tr>
