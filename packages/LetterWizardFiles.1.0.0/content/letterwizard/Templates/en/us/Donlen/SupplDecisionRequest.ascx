      ...
      <DIV>
        ...
        <div>
            <table border="0" cellpadding="0" cellspacing="0" style="padding-bottom:5px; width:100%">
                ...
                <tr>
                    <td>
                        This email requires your action. Claim #  has received a supplement repair estimate and the following table provides 
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="padding-bottom:5px; width:100%">
                            <tr>
                                <td style="width:50%">Previously Approved Repair Amount</td>
                                <td style="width:50%"><%=Me.ApprovedAmtDisplay%></td>
                            </tr>
                            <tr>
                                <td style="width:50%">Supplement Estimated Amount</td>
                                <td style="width:50%"><%=Me.SupplAmtDisplay%></td>
                            </tr>
                            <tr>
                                <td style="width:50%">Damage Estimated Amount</td>
                                <td style="width:50%"><%=Me.SupplementTotalEstimateDisplay%></td>
                            </tr>
                            <tr>
