...
<table border="0" cellpadding="0" cellspacing="0" style="padding-left:20px;">
    ...
    <tr> 
      <td class="TextBold">Hershey Assigned Driver:&nbsp;&nbsp; </td>
    ...
    <tr>
      ...
      <td class="TextNormal">At Fault or Preventable</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="TextNormal"><%=Me.FirstLetterSentDtAdd(30).DisplayDate.ToString%> </td>
    </tr>
