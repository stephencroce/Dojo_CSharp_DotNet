        ...
        <td height="100%" valign="TOP">
            ...
            <div>
              ...
              <%=Me.ZipCode%>
                            ...
                            Dear <%=Me.FirstName%>,<p>
                                I am sending you this letter in reference to your accident of <%=Me.DateOfLoss%>.  You are receiving this letter as our records indicate that your vehicle went into the shop for the repairs.  To date we have not received the <b>R</b>ental <b>A</b>greement number for your rental.  Please contact our office at your earliest convenience to advise us of the <b>RA</b> number or to advise that no rental was necessary, <%=Me.GetProperCEIName(Me.OrgCountryId, "CEI Services")%>
                                <nobr><b>1-215-364-8253 (option 1)</b></nobr>
                                or
                                <nobr><b>1-866-894-0386 (option 1)</b></nobr>
                                This information is needed to enable CEI to handle the completed subrogation for Bristol-Myers Squibb Company.<p>
        ...
        <td height="1px">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td class="TextSmallNormal" style="font: normal 5pt arial; padding-top: 5px; border-top: solid 1px #000000;" align="right">Templates/en/us/BMS_RA_InShop</td>
                </tr>
                <tr>
