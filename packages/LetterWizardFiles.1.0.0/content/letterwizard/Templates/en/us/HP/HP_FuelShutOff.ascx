...
<%
    Const TemplatePath As String = "Templates/en/us/HP/HP_FuelShutOff.ascx"
          ...
          <tr>
            <td class="TextNormal" align="left" style="padding-top:5px;">
              ...
              <%  Else%>
                ...
                <p/>
                <span class="TextBold"><u>IMPORTANT</u>: Since we have not received your payment, your fuel card privileges were cancelled, per HP’s Fleet policy. Once payment is received, the fuel card will be reactivated.</span>
                <p/>
