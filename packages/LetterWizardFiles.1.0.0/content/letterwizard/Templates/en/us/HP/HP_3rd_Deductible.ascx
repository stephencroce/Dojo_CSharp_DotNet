...
<%
    Const TemplatePath As String = "Templates/en/us/HP/HP_3rd_Deductible.ascx"
          ...
          <tr>
            <td class="TextNormal" align="left" style="padding-top:5px;">
              ...
              <%  If Me.UseAffidavit Then%>
                  ...
                  <span class="TextBold" style="color:#ffcc" >IMPORTANT: Since we have not received your Certification document for this accident/incident, your fuel card privileges are scheduled for cancellation within 48 hours, per HP’s Fleet Policy.  Once the signed Certification form is received, the fuel card will be reactivated.  If you have already submitted the Certification document please contact CEI Services at (215) 485-4284.</span><p/>
                  If you have not submitted your certification, we recommend you return the signed document by courier, and contact CEI at (215) 485-4284 with tracking information within the next 24 hours so that your fuel card will not be disabled. <p/>
              ...
              <%  Else%>
                ...
                <span class="TextBold">IMPORTANT: Since we have not received your payment for this accident/incident, your fuel card privileges are scheduled for cancellation within 48 hours, per HP’s Fleet Policy.  Once payment is received, the fuel card will be reactivated.</span><p/>
